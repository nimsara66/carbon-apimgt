...
public class AIConfigurationDTO   {
  ...
  /**
   * Whether AI is enabled for this API.
   **/
  public AIConfigurationDTO enabled(Boolean enabled) {
    this.enabled = enabled;
    return this;
  }

  
  @ApiModelProperty(value = "Whether AI is enabled for this API.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(enabled, aiConfiguration.enabled) &&
        Objects.equals(aiEndpointConfiguration, aiConfiguration.aiEndpointConfiguration) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(enabled, aiEndpointConfiguration, llmProviderName, llmProviderApiVersion, tokenBasedThrottlingConfiguration);
  }
